...
plt.savefig(f'figs/Trajectories_CF_Safe_Control_{current_time}.png', dpi=200)
plt.show()
...
plt.savefig(f'figs/States_CF_Safe_Control_{current_time}.png', dpi=200)
...
plt.savefig(f'figs/Barriers_CF_Safe_Control_{current_time}.png', dpi=200)
