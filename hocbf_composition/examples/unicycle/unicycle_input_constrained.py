...
from hocbf_composition.closed_form_safety_filter import MinInterventionInputConstrainedClosedFormSafetyFilter
...
safety_filter = MinInterventionInputConstrainedClosedFormSafetyFilter(
